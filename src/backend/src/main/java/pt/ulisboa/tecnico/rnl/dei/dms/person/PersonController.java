...
public class PersonController {
	...
	public List<PersonDto> getTeacher() {
		return personService.getTeacher();
	}
	...
	@PostMapping("/person-exists")
	public boolean checkPersonExists(@RequestBody PersonDto personDto) {
		return personService.checkPersonExists(personDto);
	}
